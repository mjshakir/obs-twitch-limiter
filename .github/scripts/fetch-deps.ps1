...
# Instead of using the "include" folder from the install (which doesn't exist),
# point to the OBS Studio fallback source for libobs headers.
...
get_filename_component(_INSTALL_PREFIX "${CMAKE_CURRENT_LIST_DIR}/../../.." ABSOLUTE)
set(obs_frontend_api_INCLUDE_DIRS "${_INSTALL_PREFIX}/../obs-studio-fallback/frontend-api")
