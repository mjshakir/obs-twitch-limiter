...
if (Test-Path $libobsPath) {
    ...
    # Configure CMake with flags to install both libobs and the frontend API.
    ...
    # Build and install OBS Studio (or at least the parts needed for libobs and frontend API).
    ...
    # Generate minimal libobsConfig.cmake if it doesn't exist.
...
'@
    ...
    # Generate minimal obs-frontend-apiConfig.cmake if it doesn't exist.
...
'@
    ...
    # For debugging, list the contents of both fallback config directories.
